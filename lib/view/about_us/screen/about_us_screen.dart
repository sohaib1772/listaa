              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10.h),
                    Text(
                      """نحن فريق تقني مستقل يضم نخبة من المطورين والمتخصصين في مجالات تطوير البرمجيات وتكنولوجيا المعلومات. نكرّس جهودنا لتصميم وتطوير حلول رقمية متقدمة تلبي احتياجات المؤسسات والأفراد، وذلك من خلال توظيف أحدث التقنيات والمنهجيات في مجالات تطوير التطبيقات . نطمح إلى صناعة تطبيقات تُحدث فرقًا حقيقيًا في تجربة المستخدم وتلبي احتياجات السوق بكفاءة واحترافية.""",
                      style: AppTextStyles.darkbold16,
