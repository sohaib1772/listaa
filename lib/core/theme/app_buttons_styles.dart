  ...
  switch(appButtonType){
    case AppButtonType.orange:
      return ButtonStyle(
        ...
        textStyle: WidgetStatePropertyAll(AppTextStyles.darkbold20.copyWith(fontFamily: "Cairo",color: Colors.black)),
    ...
    case AppButtonType.floatingButton:
      return ButtonStyle(
                overlayColor: WidgetStatePropertyAll(AppColors.floatingButtonBorderColor),
        backgroundColor: WidgetStatePropertyAll(AppColors.floatingButtonColor),
        shape: WidgetStatePropertyAll(
        
          RoundedRectangleBorder(
            
            side: BorderSide(color: AppColors.floatingButtonBorderColor,width: 3),
            borderRadius: BorderRadius.circular(10))),
      );
  }
}